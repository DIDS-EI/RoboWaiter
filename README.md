...
✨️ 我们上传了精简版的  https://github.com/DIDS-EI/OBTEA-demo ，如果想 generating BT file for your custom task， 可以参考 `OBTEA-demo/test_demo/run_demo_task.py` 。
...
1. 下载[仿真器](https://drive.google.com/file/d/1ayAQZbPOyQV2W-V_ZdYv6AoqLOg0zvm1/view?usp=sharing)，解压并运行CafeSimulator.exe，即可打开仿真器，此时显示空场景，等待代码端生成场景并完成机器人交互。如果链接打不开，可以用百度网盘：
